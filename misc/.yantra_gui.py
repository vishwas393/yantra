...
import rospy
from yantra.msg import Position
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.horizontalLayoutWidget_4.setGeometry(QtCore.QRect(20, 130, 1071, 311))
        ...
        self.pushButton.setGeometry(QtCore.QRect(170, 90, 121, 31))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.pushButton.setFont(font)
        self.pushButton.setObjectName("pushButton")
        self.pushButton.clicked.connect(lambda: self.send_path_points())
    ...
    def retranslateUi(self, Form):
        ...
        self.pos1y_4.setText(_translate("Form", "300"))
    ...
    def send_path_points(self):
        ...
        p1 = Position()
        p1.pos = [int(self.pos1x_4.text()), int(self.pos1y_4.text()), int(self.pos1z_4.text())]

        p2 = Position()
        p2.pos = [int(self.pos1x_3.text()), int(self.pos1y_3.text()), int(self.pos1z_3.text())]

        p3 = Position()
        p3.pos = [int(self.pos1x.text()), int(self.pos1y.text()), int(self.pos1z.text())]

        p4 = Position()
        p4.pos = [int(self.pos1x_2.text()), int(self.pos1y_2.text()), int(self.pos1z_2.text())]
    


    def __init__(self):
        rospy.init("yantra_gui")
